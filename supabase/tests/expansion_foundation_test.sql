...
select lives_ok($$insert into runs(act_id,category_key,slug) select 'e2000000-0000-4000-8000-000000000003',key,'draft-'||replace(key,'_','-') from fundraiser_categories$$,'every category in the registry saves a minimal draft under the owner session');
