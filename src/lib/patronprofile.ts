 ...
 *
 * The public page reads the sanitised views from migration 0024 through the ordinary anon client.
 ...
 *
 * Retired usernames are kept for good (migration 0024), so a link somebody wrote down a year ago
