...
export const RESERVED_SLUGS = new Set([
  ...
  "cookies", "dashboard", "door-money", "doormoney", "embed", "forgot", "fundraiser", "fundraisers", "how-sponsorship-works", "icon", "inbox", "list", "login",
  "mark", "new", "newsletter", "patron", "patrons", "placements", "privacy", "record", "refunds", "reset", "robots", "signup",
