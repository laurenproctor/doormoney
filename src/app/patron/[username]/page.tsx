...
import { formatMonth, impactTotals, initialsFor, profileLink, yearOf } from "@/lib/profile";
          ...
          {activity.length === 0 ? (
            ...
            <>
              ...
              <ul className="divide-y divide-line border-y border-line">
                {activity.map((a, i) => (
                  <PatronActivityItem key={`${a.kind}-${a.actSlug}-${a.runTitle}-${i}`} item={activityView(a)} />
                ))}
              </ul>
            </>
          )}
...
function activityView(item: PublicActivity): PatronActivityView {
