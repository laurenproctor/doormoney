...
export const metadata: Metadata = {
  ...
  description:
    "The sponsorship options a musician can offer on Door Money, with suggested prices: onstage, around the room, online and in print.",
  alternates: { canonical: "/how-sponsorship-works/music" },
  openGraph: {
    type: "website",
    url: "/how-sponsorship-works/music",
...
/*
  Music's own page under "How sponsorship works". The shared page one level up explains the exchange
  for every category and names no category's inventory. This one is about music and says so: the
  options a musician can offer, Door Money's suggested prices for them (music is the category with a
  sales history to suggest from), the stage drawing, and the ways a musician documents a placement.
  It was the whole of /how-sponsorship-works until the site stopped being music-only (decision 17).
...
export default function HowMusicSponsorshipWorksPage() {
  return (
    <Page
      theme="lime"
      current="/how-sponsorship-works"
      eyebrow="How sponsorship works: music"
      title="How music"
    ...
    >
      ...
      <Section>
        <SectionHead eyebrow="Exclusivity">One musician. One sponsor per line of business.</SectionHead>
        <div className="edge glow mt-9 max-w-[760px] bg-accent text-on-accent px-7 py-[30px]">
          ...
          <p className="mt-2 text-[15px] leading-[1.6]">
            ...
            gear slot to itself. Musicians can make that exclusivity available, and price it accordingly.
          </p>
        </div>
      </Section>
      ...
      <Section className="pb-24">
        <SectionHead eyebrow="Get started">{SITE.musicTagline}</SectionHead>
        <p className="max-w-[62ch]">
