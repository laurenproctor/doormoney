 ...
 * key, which is what the save action reads.
 *
 * Five things, and deliberately only five. They are what an organizer changes often, so the row
 * stays a row: everything a sponsor has to read before they pay is a separate, collapsed section
 * that the form around this one draws underneath it. The draft carries the expected reach and its
 * basis because they belong to this option, and they are edited down there with the audience they
 * describe rather than here beside the price.
 *
